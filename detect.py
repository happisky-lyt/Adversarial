...
def run(weights=ROOT / 'yolov3.pt',  # model.pt path(s)
    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        pred, feature = model(im, augment=augment, visualize=visualize)
        t3 = time_sync()
        dt[1] += t3 - t2
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'E:/python/kaiti/yolov3/runs/train/exp3/weights/best.pt', help='model path(s)')
